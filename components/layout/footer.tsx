        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 rounded-lg bg-primary-light border border-primary-light flex items-center justify-center text-gray-300 hover:text-accent hover:border-accent/50 transition-all duration-200">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/urunler" className="text-gray-300 hover:text-accent transition-colors">
                  Tüm Ürünler
                </Link>
              </li>
              <li>
                <Link href="/kategoriler" className="text-gray-300 hover:text-accent transition-colors">
                  Kategoriler
                </Link>
              </li>
              <li>
                <Link href="/markalar" className="text-gray-300 hover:text-accent transition-colors">
                  Markalar
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/hakkimizda" className="text-gray-300 hover:text-accent transition-colors">
                  Hakkımızda
                </Link>
              </li>
              <li>
                <Link href="/iletisim" className="text-gray-300 hover:text-accent transition-colors">
                  İletişim
                </Link>
              </li>
              <li>
                <Link href="/kvkk" className="text-gray-300 hover:text-accent transition-colors">
                  KVKK
                </Link>
              </li>
              <li>
                <Link href="/iade-politikasi" className="text-gray-300 hover:text-accent transition-colors">
                  İade Politikası
                </Link>
              </li>
            </ul>
